...
import { getEvent, deleteEvent, publishEvent, unpublishEvent, EventData } from '../services/eventService';
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={event.isPublic ? "text-orange-600 hover:text-orange-700 hover:bg-orange-50" : "text-green-600 hover:text-green-700 hover:bg-green-50"}
          >
            {event.isPublic ? (
              <>

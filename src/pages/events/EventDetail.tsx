        ...
        if (eventData.creatorId) {
          try {
            ...
            const name =
              ...
              eventData.creatorSchoolName !== "Admin"
                ? eventData.creatorSchoolName
                : user?.schoolName ||
                  user?.schoolname ||
                  user?.fullName ||
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
            <span>
              ...
              {event.timestamp
                ? new Date(
                    (event.timestamp as any).seconds * 1000
                  ).toLocaleDateString()
                : "N/A"}
            </span>
            <span>•</span>
          ...
          <div className="bg-card p-6 rounded-xl shadow-sm border border-border space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-foreground">Forane</p>
                  <p className="text-sm text-muted-foreground">
                    {event.creatorSchoolName || "N/A"}
                  </p>
                </div>
              </div>

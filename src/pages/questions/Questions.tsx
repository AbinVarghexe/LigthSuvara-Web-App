...
const SortableRow = ({
  ...
  return (
    <TableRow
      ...
      {...attributes}
      className={
        isDragging ? "bg-muted/80 shadow-lg relative z-50" : "bg-card relative"
      }
    >
      ...
      <TableCell>
        {editingId === question.id ? (
          <Textarea
            ...
            onChange={(e) =>
              setInlineEditData({ ...inlineEditData, text: e.target.value })
            }
            rows={2}
...
interface QuestionCardProps extends Omit<
  SortableRowProps,
  "handleDeleteQuestion"
> {
  handleDeleteQuestion: (id: string) => void;
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
              <Label htmlFor={`mandatory-${question.id}`} className="text-xs">
                Mandatory
              </Label>
              <Switch
...
export function Questions() {
  ...
  const handleToggleMandatory = async (question: QuestionData) => {
    try {
      await toggleMandatory(question.id!, question.mandatory || false);
  ...
  const generateQuestionPaper = async () => {
    ...
    doc.text("FAITH FORMATION PROGRAM", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new assessment question for the Faith Formation
                  program.
                </DialogDescription>
              </DialogHeader>

...
- **Role-Based Management** — Distinct portals for Admins, Schools, and Animators.
- **Event Orchestration** — Complete workflow involves creation, approval, and rejection.
- **Data Visualization** — Radar and Bar charts for actionable insights.
- **Theme Awareness** — Stunning Dark/Light mode with circular reveal transitions.
- **Bulk Operations** — CSV uploads for efficient user management.
- **Mobile Optimized** — A seamless experience across all devices.
